...
function resetVibeSelection() {
  ...
  const vibeOpts = document.getElementById('vibeOptions');
  const vibeHead = document.getElementById('vibeHeaderTitle');
  if (vibeOpts) vibeOpts.style.display = 'flex';
  if (vibeHead) vibeHead.style.display = 'block';
